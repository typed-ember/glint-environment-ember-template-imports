...
type OptNamed<N extends Record<string, unknown> | undefined> =
  N extends undefined ? NonNullable<N> | EmptyObject : N;
...
export declare function resolve<
  ...
  T
>(
  item: (...args: [...positional: P, named: N]) => T
): (named: OptNamed<N>, ...positional: P) => T;
export declare function resolve<P extends unknown[], T>(
  item: (...positional: P) => T
